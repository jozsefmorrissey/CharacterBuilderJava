...
public class UserDescriptionSrvcImpl //implements SkillDescriptionSrvc 
{
//	@Autowired
...
//		skillDescRepo.deleteByDescIdId(skillMap.getId());
//	}
//
//	@Override
//	@Transactional
...
//			skillDescs.add(new SkillDescription(skillMap.getId(), strs[index], index));
//		}
